...
return [
    'check_processing' => [
        'prompt' => '
            ...
            Количество - это единицы, штуки. Вес - это вес или объем, измеряется в кг или литрах, если не нашел - поставь 0. Найти если есть время в формате Y-m-d H:i:s (datetime).
