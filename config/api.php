...
return [
    'check_processing' => [
        'prompt' => '
            ...
            Извлеки только те товары, в которых информация читаема, остальное игнорируй.
            Извлеки нформацию о каждом наименовании товара, его количество, цену и вес (приведи в кг, если не нашел - поставь 0) в массив (name/quantity/price/weight).
            Найти если есть время в формате Y-m-d H:i:s (datetime).
